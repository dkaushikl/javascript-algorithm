...
describe('Reverse Int program', function () {
  'use strict';
  ...
  it('reverse int using method 1', () => {
    ...
    expect(ReverseInt.One(null)).toEqual('');
    expect(ReverseInt.One(0)).toEqual(-0);
    expect(ReverseInt.One(undefined)).toEqual('');
  ...
  it('reverse int using method 2', () => {
    ...
    expect(ReverseInt.Two(543.2100)).toEqual(12.345);
    expect(ReverseInt.Two(-543.2100)).toEqual(-12.345);
  });
  ...
  it('reverse int using method 3', () => {
    ...
    expect(ReverseInt.Three(543.2100)).toEqual(12.345);
    expect(ReverseInt.Three(-543.2100)).toEqual(-12.345);
  });
  ...
  it('reverse int using method 4', () => {
    ...
    expect(ReverseInt.Forth(543.2100)).toEqual(12.345);
    expect(ReverseInt.Forth(-543.2100)).toEqual(-12.345);
  })
});
