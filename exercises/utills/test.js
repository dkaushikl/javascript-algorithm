const Utills = require('./index.js');

describe('Utills', function () {
  'use strict';

  it('check string is empty', () => {
    expect(Utills.CheckStringEmpty('')).toEqual(false);
    expect(Utills.CheckStringEmpty()).toEqual(false);
    expect(Utills.CheckStringEmpty(null)).toEqual(false);
    expect(Utills.CheckStringEmpty(undefined)).toEqual(false);
    expect(Utills.CheckStringEmpty(' ')).toEqual(false);
  ...
  it('check number is empty', () => {
    ...
    expect(Utills.CheckNumberEmpty()).toEqual(false);
    expect(Utills.CheckNumberEmpty(null)).toEqual(false);
    expect(Utills.CheckNumberEmpty(undefined)).toEqual(false);
    expect(Utills.CheckNumberEmpty(' ')).toEqual(false);
  ...
  it('convert number to string', () => {
    ...
    expect(Utills.ConvertToString()).toEqual('');
    expect(Utills.ConvertToString(null)).toEqual('');
    expect(Utills.ConvertToString(undefined)).toEqual('');
    ...
    expect(Utills.ConvertToString('01')).toEqual('01');
    expect(Utills.ConvertToString(543.2100)).toEqual('543.21');
    expect(Utills.ConvertToString('.')).toEqual('.');
  });

  it('convert positive to negative number', () => {
    expect(Utills.ConvertNagativeInteger('')).toEqual('');
    expect(Utills.ConvertNagativeInteger()).toEqual('');
    expect(Utills.ConvertNagativeInteger(null)).toEqual('');
    expect(Utills.ConvertNagativeInteger(undefined)).toEqual('');
  ...
  it('convert to number', () => {
    expect(Utills.ConvertToNumber('')).toEqual('');
    expect(Utills.ConvertToNumber()).toEqual('');
    expect(Utills.ConvertToNumber(null)).toEqual('');
    expect(Utills.ConvertToNumber(undefined)).toEqual('');
  ...
  it('check array is empty', () => {
    ...
    expect(Utills.CheckArrayEmpty()).toEqual(false);
    expect(Utills.CheckArrayEmpty(null)).toEqual(false);
    expect(Utills.CheckArrayEmpty(undefined)).toEqual(false);
